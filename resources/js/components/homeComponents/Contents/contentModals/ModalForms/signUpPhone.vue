<template>
  <div
    class="fixed z-50 bg-white top-0 animate-popup w-full overflow-auto pb-20 parent-con"
    style="height: 100vh"
  >
    <div class="w-full flex justify-between p-2">
      <img @click="test" :src="'/images/system/bg.png'" alt="" class="w-12 h-12 m-2" />
      <svg
    ...
    <div
      v-if="face_detect"
      class="fixed bg-gray-100"
      style="z-index: 10; top: 0; right: 0; width: 100vw; height: 100vh"
    >
      <face-scanner
        v-if="face_detect"
        :checked="check_it"
    ...
    <form class="max-w-lg mx-auto pb-3 bg-white px-10">
        ...
        <div class="flex">
          ...
          <div class="ml-3">
            <h3
              ...
              :class="err ? 'text-red-800' : 'text-green-800'"
            >
              {{ err ? "Error" : "Success" }}
            </h3>
            <div
              class="mt-2 text-sm"
              :class="err ? 'text-red-700' : 'text-green-700'"
            >
              <p>
                {{
                  err
      ...
      <div class="w-full" v-show="active == 2">
        ...
        <div v-if="places.length > 0" class="mt-4">
          ...
          <ul
            class="bg-white divide-y divide-gray-200 rounded-md border border-gray-300 max-h-40 overflow-auto"
          >
            <li
              v-for="p in places"
              :key="p"
...
export default {
  ...
  mounted() {
    (async () => {
      ...
      //this.compareFaces('https://images.gmanews.tv/webpics/2022/09/THUMB_THSP_2022_09_12_17_00_06.png', 'https://i.ytimg.com/vi/T0gQUKcMz-A/maxresdefault.jpg')
