      ...
      <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
        <div class="bg-gradient-to-r from-red-500 to-pink-500 px-4 py-5 sm:px-6">
          <div class="flex items-center justify-between">
            ...
            <button @click="toggle('')" class="text-white hover:text-gray-200 focus:outline-none">
            ...
            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
              <div class="mt-2">
                <p class="text-sm text-gray-500">
                  Are you sure you want to reject this incident report? This action cannot be undone.
                </p>
              </div>
              <div class="mt-4">
                <label for="message" class="block text-sm font-medium text-gray-700">Reason for rejection</label>
                <textarea
                  id="message"
                  v-model="rej_message"
                  rows="4"
        ...
        <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
          <button
            ...
            :class="{'opacity-50 cursor-not-allowed': rej_message === ''}"
            :disabled="rej_message === ''"
            @click="sendData(rej_message)"
          >
            Reject Report
          </button>
          <button
